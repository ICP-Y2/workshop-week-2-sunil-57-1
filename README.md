...
We observed that when four 1.5 V of battery is connected in series connection, the multimeter
showed overall volatage of 6 V.
Hence, when the batteries are connected in series, the overall voltage
across the circuit is the sum of the voltage of the batteries.
...
We observed that when four 1.5 V of battery is connected in parallel connection, the multimeter
showed overall volatage of 1.5 V.
Hence, when the batteries are connected in parallel, the overall voltage
across the circuit is same.
